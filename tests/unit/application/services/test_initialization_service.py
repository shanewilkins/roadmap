...
from roadmap.application.services.initialization_service import (
...
class TestProjectInitializationService:
    ...
    def service(self, mock_core):
        ...
        with patch(
            "roadmap.application.services.initialization_service.InitializationWorkflow"
        ):
    ...
    def test_validate_prerequisites_returns_tuple(self, service):
        ...
        with patch(
            "roadmap.application.services.initialization_service.InitializationValidator"
        ) as mock_validator:
