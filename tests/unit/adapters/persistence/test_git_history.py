...
class TestFindCommitAtTime:
    ...
    def test_find_commit_with_datetime(self, mock_git):
        """Test finding commit with datetime object."""
        mock_git.return_value = "abc123def456 2026-01-03T10:30:00+00:00"
    ...
    @patch("roadmap.adapters.persistence.git_history._run_git_command")
    def test_find_commit_with_iso_string(self, mock_git):
        """Test finding commit with ISO 8601 timestamp string."""
        mock_git.return_value = "xyz789 2026-01-03T10:30:00+00:00"
    ...
    @patch("roadmap.adapters.persistence.git_history._run_git_command")
    def test_find_commit_with_file_path(self, mock_git):
        """Test finding commits that affected a specific file."""
        mock_git.return_value = "file123 2026-01-03T10:30:00+00:00"
    ...
    @patch("roadmap.adapters.persistence.git_history._run_git_command")
    def test_find_commit_no_commits_returns_first(self, mock_git):
    ...
    @patch("roadmap.adapters.persistence.git_history._run_git_command")
    def test_find_commit_invalid_timestamp_format(self, mock_git):
...
class TestGetFileAtCommit:
    ...
    @patch("roadmap.adapters.persistence.git_history._run_git_command")
    def test_get_file_at_commit(self, mock_git):
        """Test retrieving file content at commit."""
        mock_git.return_value = "file content here\nline 2"
    ...
    @patch("roadmap.adapters.persistence.git_history._run_git_command")
    def test_get_file_at_commit_not_found(self, mock_git):
        """Test error when file not found at commit."""
        mock_git.side_effect = GitHistoryError("does not exist in commit abc123")

        with pytest.raises(FileNotFound):
            get_file_at_commit("missing.md", "abc123")

    @patch("roadmap.adapters.persistence.git_history._run_git_command")
    def test_get_file_at_head(self, mock_git):
        """Test retrieving file from HEAD."""
        mock_git.return_value = "current content"
...
class TestGetLastModifiedTime:
    ...
    @patch("roadmap.adapters.persistence.git_history._run_git_command")
    def test_get_last_modified_time(self, mock_git):
        """Test getting last modification time."""
        mock_git.return_value = "2026-01-03T10:30:45+00:00"
    ...
    @patch("roadmap.adapters.persistence.git_history._run_git_command")
    def test_get_last_modified_time_not_in_history(self, mock_git):
    ...
    @patch("roadmap.adapters.persistence.git_history._run_git_command")
    def test_get_last_modified_time_error(self, mock_git):
        """Test error handling."""
        mock_git.side_effect = GitHistoryError("git command failed")
...
class TestRepositoryChecks:
    ...
    @patch("roadmap.adapters.persistence.git_history._run_git_command")
    def test_is_git_repository_true(self, mock_git):
    ...
    @patch("roadmap.adapters.persistence.git_history._run_git_command")
    def test_is_git_repository_false(self, mock_git):
        """Test detecting non-git directory."""
        mock_git.side_effect = NotAGitRepository("not a repo")
    ...
    @patch("roadmap.adapters.persistence.git_history._run_git_command")
    def test_get_repository_root(self, mock_git):
        """Test getting repository root."""
        mock_git.return_value = "/home/user/projects/roadmap"
    ...
    @patch("roadmap.adapters.persistence.git_history._run_git_command")
    def test_get_repository_root_not_git_repo(self, mock_git):
...
class TestGetChangedFiles:
    ...
    @patch("roadmap.adapters.persistence.git_history._run_git_command")
    def test_get_changed_files_since_commit(self, mock_git):
        """Test getting changed files list."""
        mock_git.return_value = "file1.md\nfile2.py\ndir/file3.txt"
    ...
    @patch("roadmap.adapters.persistence.git_history._run_git_command")
    def test_get_changed_files_no_changes(self, mock_git):
    ...
    @patch("roadmap.adapters.persistence.git_history._run_git_command")
    def test_get_changed_files_custom_ref(self, mock_git):
        """Test with custom git reference."""
        mock_git.return_value = "changed.md"
