...
class TestGitBranchManagerInit:
    ...
    def test_init_default_path(self, mocker):
        ...
        mocker.patch("roadmap.adapters.git.git_branch_manager.GitCommandExecutor")
        manager = GitBranchManager()
        assert manager.repo_path == Path.cwd()
        assert manager.config is None

    def test_init_custom_path(self, mocker):
    ...
    def test_init_with_config(self, mocker, mock_config_factory):
...
class TestGenerateTitleSlug:
    ...
    def test_slug_simple_title(self, mocker):
    ...
    def test_slug_removes_special_chars(self, mocker):
    ...
    def test_slug_lowercase(self, mocker):
    ...
    def test_slug_replaces_spaces_with_hyphens(self, mocker):
    ...
    def test_slug_length_limited(self, mocker):
    ...
    def test_slug_various_titles(self, mocker, title, expected_in_slug):
...
class TestDeterminePrefix:
    ...
    def test_prefix_default_feature(self, mocker, mock_issue_factory):
    ...
    def test_prefix_bugfix_for_bug_type(self, mocker, mock_issue_factory):
    ...
    def test_prefix_docs_for_documentation_type(self, mocker, mock_issue_factory):
    ...
    def test_prefix_hotfix_for_critical_priority(self, mocker, mock_issue_factory):
    ...
    def test_prefix_various_types(
        self, mocker, issue_type, expected, mock_issue_factory
    ):
...
class TestFormatBranchName:
    ...
    def test_format_with_default_template(self, mocker):
    ...
    def test_format_with_custom_template(self, mocker):
    ...
    def test_format_with_invalid_template_falls_back(self, mocker):
...
class TestSuggestBranchName:
    ...
    def test_suggest_includes_issue_id(self, mocker, mock_issue_factory):
    ...
    def test_suggest_includes_slug(self, mocker, mock_issue_factory):
    ...
    def test_suggest_includes_prefix(self, mocker, mock_issue_factory):
...
class TestCheckWorkingTreeClean:
    ...
    def test_clean_tree_returns_true(self, mocker, mock_git_executor_factory):
    ...
    def test_dirty_tree_returns_false(self, mocker, mock_git_executor_factory):
    ...
    def test_force_returns_true_regardless(self, mocker, mock_git_executor_factory):
    ...
    def test_untracked_files_ignored(self, mocker, mock_git_executor_factory):
...
class TestBranchAlreadyExists:
    ...
    def test_branch_exists_returns_true(self, mocker, mock_git_executor_factory):
    ...
    def test_branch_not_exists_returns_false(self, mocker, mock_git_executor_factory):
...
class TestHandleExistingBranch:
    ...
    def test_checkout_existing_branch(self, mocker, mock_git_executor_factory):
    ...
    def test_skip_checkout_existing_branch(self, mocker, mock_git_executor_factory):
...
class TestCreateBranchForIssue:
    ...
    def test_create_branch_not_git_repo(
        self, mocker, mock_git_executor_factory, mock_issue_factory
    ):
...
class TestGetCurrentBranch:
    ...
    def test_get_current_branch_success(self, mocker, mock_git_executor_factory):
    ...
    def test_get_current_branch_detached_head(self, mocker, mock_git_executor_factory):
...
class TestGetAllBranches:
    ...
    def test_get_all_branches_none(self, mocker, mock_git_executor_factory):
    ...
    def test_get_all_branches_multiple(self, mocker, mock_git_executor_factory):
