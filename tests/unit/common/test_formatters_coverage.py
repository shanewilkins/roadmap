...
class TestFormatTable:
    ...
    @pytest.mark.parametrize("title,columns,rows,has_content", [
        ("Test Table", ["Name", "Age"], [("Alice", 30), ("Bob", 25)], True),
        ("Empty Table", ["Col1", "Col2"], [], False),
        ("Many Rows", ["Row", "Value"], [(f"Row{i}", f"Value{i}") for i in range(10)], True),
...
class TestFormatPanel:
    ...
    @pytest.mark.parametrize("content,title,expand", [
    ...
    def test_format_panel_variants(self, content, title, expand):
        ...
        panel = format_panel(content, **{k: v for k, v in kwargs.items() if v is not None})
...
class TestFormatStatusMessages:
    ...
    @pytest.mark.parametrize("format_func,message", [
...
class TestFormatList:
    ...
    @pytest.mark.parametrize("items,title,has_content", [
...
class TestFormatKeyValuePairs:
    ...
    @pytest.mark.parametrize("pairs,title", [
...
class TestFormatPercentage:
    ...
    @pytest.mark.parametrize("value,decimals,expected_substring", [
        (0.75, None, "75"),
        (0.33333, 2, "33"),
        (0.0, None, "0"),
        (1.0, None, "100"),
...
class TestFormatCount:
    ...
    @pytest.mark.parametrize("count,singular,plural,expected_in_result", [
        (1, "item", None, "1"),
        (5, "item", None, "5"),
...
class TestFormatJson:
    ...
    @pytest.mark.parametrize("data,indent,check_string", [
