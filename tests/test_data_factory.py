...
class TestDataFactory:
    ...
    def create_mock_core(**kwargs) -> Mock:
        ...
        core.add_issue.return_value = kwargs.get('add_issue_return', TestDataFactory.create_mock_issue())
    ...
    def create_github_webhook_payload(event_type: str, **kwargs) -> Dict[str, Any]:
        ...
        if event_type == 'issues':
            ...
            base_payload.update({
                ...
                'head_commit': kwargs.get('head_commit', {
                    'message': 'Test commit message',
                    'id': 'abc123'
                })
            })
    ...
    def create_github_api_response(endpoint: str, **kwargs) -> Dict[str, Any]:
        ...
        if endpoint == 'issues':
            return {
                ...
                'html_url': kwargs.get('html_url', 'https://github.com/test/repo/issues/123')
            }
        elif endpoint == 'repos':
            return {
                ...
                'html_url': kwargs.get('html_url', 'https://github.com/test-owner/test-repo')
            }
        elif endpoint == 'user':
            return {
