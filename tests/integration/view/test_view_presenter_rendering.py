...
class TestMilestonePresenterFullRendering:
    ...
    def test_render_with_all_components(
        ...
        with patch.object(presenter, "_get_console") as mock_console:
            presenter.render(
                milestone_with_all_components["milestone_dto"],
                issues=mock_issues,
...
class TestProjectPresenterFullRendering:
    ...
    def test_render_with_all_components(
        self, project_with_all_components, effort_data, project_description_content
    ):
        ...
        with patch.object(presenter, "_get_console") as mock_console:
            presenter.render(
                project_with_all_components["project_dto"],
    ...
    def test_render_with_large_effort_estimate(
        ...
        with patch.object(presenter, "_get_console") as mock_console:
            presenter.render(
                ...
                effort_data=large_effort_data,
            )
            # Verify effort table was rendered
            assert mock_console.return_value.print.call_count >= 2
