...
def register_deprecated_commands(main_group):
    ...
    @click.option(
        "--suggest-rebalance", is_flag=True, help="Suggest workload rebalancing"
    )
    @click.pass_context
    ...
    @click.option(
        "--consider-availability", is_flag=True, help="Consider current workload"
    )
    ...
    def smart_assign(
        ...
        """
        console.print(
            "⚠️  DEPRECATION WARNING: 'roadmap smart-assign' is deprecated.",
            style="yellow",
        )
        console.print(
    ...
    def dashboard(ctx: click.Context, assignee: str, days: int):
        ...
        """
        console.print(
            "⚠️  DEPRECATION WARNING: 'roadmap dashboard' is deprecated.", style="yellow"
        )
        console.print(
            "   Use 'roadmap user show-dashboard' instead for better organization.",
            style="yellow",
        )
    ...
    def notifications(ctx: click.Context, assignee: str, since: str, mark_read: bool):
        ...
        """
        console.print(
            "⚠️  DEPRECATION WARNING: 'roadmap notifications' is deprecated.",
            style="yellow",
        )
        console.print(
            "   Use 'roadmap user show-notifications' instead for better organization.",
            style="yellow",
        )
