...
from roadmap.adapters.inbound.cli.milestones.archive import archive_milestone
from roadmap.adapters.inbound.cli.milestones.assign import assign_milestone
from roadmap.adapters.inbound.cli.milestones.close import close_milestone
from roadmap.adapters.inbound.cli.milestones.create import create_milestone
from roadmap.adapters.inbound.cli.milestones.delete import delete_milestone
from roadmap.adapters.inbound.cli.milestones.kanban import milestone_kanban
from roadmap.adapters.inbound.cli.milestones.list import list_milestones
from roadmap.adapters.inbound.cli.milestones.recalculate import (
    recalculate_milestone_progress,
)
from roadmap.adapters.inbound.cli.milestones.restore import restore_milestone
from roadmap.adapters.inbound.cli.milestones.update import update_milestone
from roadmap.adapters.inbound.cli.milestones.view import view_milestone
