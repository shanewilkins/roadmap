...
from roadmap.adapters.inbound.cli.models import ColumnDef, ColumnType
from roadmap.domain.types import IssueStatus, Priority, ProjectStatus
...
def create_status_column(
    ...
    if enum_values is None:
        enum_values = [status.value for status in IssueStatus]
