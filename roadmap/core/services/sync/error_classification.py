...
class ErrorClassifier:
    ...
    def _get_suggested_fix(self, category: ErrorCategory, error_message: str) -> str:
        ...
        suggestions = {
            ...
            ErrorCategory.AUTHENTICATION_FAILED: "Run 'roadmap config github' to reconfigure GitHub token",
            ErrorCategory.PERMISSION_DENIED: "Verify GitHub token has required permissions (repo, read:org, read:user)",
            ErrorCategory.TOKEN_EXPIRED: "Generate new GitHub token and update with 'roadmap config github'",
