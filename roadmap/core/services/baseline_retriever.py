...
class BaselineRetriever:
    ...
    The concrete implementation favors `core.db.get_sync_baseline()` when
    available, then `db_session.get_sync_baseline()`. If neither is present,
    an empty baseline snapshot is returned.
    """
