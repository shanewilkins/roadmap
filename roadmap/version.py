...
class VersionManager:
    ...
    def get_init_version(self) -> Optional[SemanticVersion]:
    ...
    def check_version_consistency(self) -> Dict[str, Any]:
        ...
        result['pyproject_version'] = str(pyproject_version) if pyproject_version else None
    ...
    def generate_changelog_entry(self, version: SemanticVersion, 
                                issues: List[Issue], 
