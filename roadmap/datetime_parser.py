...
class UnifiedDateTimeParser:
    ...
    @classmethod
    def parse_any_datetime(cls, value: Any, source_type: str = "user", 
                          assumed_timezone: Optional[str] = None) -> Optional[datetime]:
    ...
    def parse_github_timestamp(cls, github_timestamp: str) -> datetime:
        ...
        try:
            ...
            raise ValueError(f"Invalid GitHub timestamp format: {github_timestamp}") from e
    
    @classmethod 
    def parse_file_datetime(cls, value: str, assumed_timezone: Optional[str] = None) -> Optional[datetime]:
    ...
    @classmethod
    def parse_user_datetime(cls, value: str, assumed_timezone: Optional[str] = None) -> Optional[datetime]:
    ...
    @classmethod
    def parse_iso_datetime(cls, value: str, assumed_timezone: Optional[str] = None) -> Optional[datetime]:
    ...
    @classmethod
    def _parse_with_formats(cls, value: str, formats: list, 
                           assumed_timezone: Optional[str] = None) -> Optional[datetime]:
...
def parse_datetime(value: Any, source_type: str = "user", 
                  assumed_timezone: Optional[str] = None) -> Optional[datetime]:
    """Convenience function for universal datetime parsing."""
    return UnifiedDateTimeParser.parse_any_datetime(value, source_type, assumed_timezone)
...
def parse_file_datetime(value: str, assumed_timezone: Optional[str] = None) -> Optional[datetime]:
    """Convenience function for file datetime parsing."""
    return UnifiedDateTimeParser.parse_file_datetime(value, assumed_timezone)


def parse_user_datetime(value: str, assumed_timezone: Optional[str] = None) -> Optional[datetime]:
